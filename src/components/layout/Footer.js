    ...
    <ContextInput.Provider value={{ input, setInput, mensagemBoolean }}>
      <FooterWrapper>
        ...
        <div className="footer_contatos">
          <p>Desenvolvido por <span className="contatos_nome">Luciano Mariano</span> 2024</p>
          <p>Meus contatos:</p>
          <p className="contatos_redes_sociais">
            <span className="social_github">
              <a href='https://github.com/lucianoafmariano' alt='Media social Github'>
                <BsGithub />
              </a>
            </span>
            <span className="social_linkedin">
              <a href='https://www.linkedin.com/in/lucianoafmariano/' alt='Media social Linkedin'>
                <BsLinkedin />
              </a>
            </span>
          </p>
